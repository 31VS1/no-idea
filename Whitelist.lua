...
local function vapeGithubRequest(scripturl)
	if not isfile("vape/"..scripturl) then
		...
		suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/31VS1/no-idea/"..readfile("vape/commithash.txt").."/"..scripturl, true) end)
...
if not shared.VapeDeveloper then 
	local commit
	for i,v in pairs(game:HttpGet("https://github.com/31VS1/no-idea"):split("\n")) do 
...
return loadstring(vapeGithubRequest("Whitelist.lua"))()
